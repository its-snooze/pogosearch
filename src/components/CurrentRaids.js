...
const tierConfig = {
  ...
  shadow5: { name: 'Shadow 5-Star Raids', icon: '🌑', color: 'from-purple-900 to-purple-700' },
  shadow3: { name: 'Shadow 3-Star Raids', icon: '🌘', color: 'from-blue-900 to-blue-700' },
  shadow1: { name: 'Shadow 1-Star Raids', icon: '🌚', color: 'from-green-900 to-green-700' }
};
...
const CurrentRaids = () => {
  ...
  const tierOrder = [5, 'mega', 3, 1, 'shadow5', 'shadow3', 'shadow1'];
            ...
            return (
              <div key={tier} className="mb-8">
                ...
                <button
                  ...
                  className={`w-full bg-gradient-to-r ${config.color} rounded-lg p-4 mb-4 hover:opacity-90 transition-opacity`}
                >
                  <h2 className="text-2xl font-bold text-white flex items-center gap-2">
                    {/* Collapse/Expand Icon */}
                    <span className="text-xl">
                      {collapsedSections[tier] ? '▶' : '▼'}
                    </span>
